...
function BestSellersBooksCarousel() {
                    ...
                    <CardContent className="flex w-full flex-col items-center justify-center">
                      ...
                      <CardHeader className="w-full p-0 pt-2 text-left lg:p-0 lg:pt-4">
                        ...
                        {book.saleInfo?.listPrice ? (
                          <CardDescription className="text-xs font-normal text-black transition-colors duration-200 group-hover:text-gray-900">
...
export default BestSellersBooksCarousel;
