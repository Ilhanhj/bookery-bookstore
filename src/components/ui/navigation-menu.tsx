...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-medium transition-colors disabled:pointer-events-none data-[active]:bg-transparent data-[state=open]:bg-transparent dark:bg-neutral-950 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[active]:bg-neutral-800/50 dark:data-[state=open]:bg-neutral-800/50",
);
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    {""}
    <ChevronDown
      className="relative top-[1px] ml-1 h-6 w-6 text-yellow-600 transition duration-200 group-data-[state=open]:rotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
));
