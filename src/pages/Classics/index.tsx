...
import ClassicsViews from "@/views/ClassicsViews";

const ClassicsPage = ({ books }: { books: Book[] }) => {
  return (
    <div className="bg-neutral-100">
      ...
      <div className="w-full bg-neutral-200 py-10 lg:py-20">
        <div className="mx-auto text-center lg:w-full lg:ps-14 lg:text-left">
          ...
          <SubTitleCategory>
            Discover the most popular classic books and read them in your
            library.
          </SubTitleCategory>
        </div>
      </div>
...
export const getServerSideProps = async () => {
  ...
  const res = await fetch(
    `https://www.googleapis.com/books/v1/volumes?q=subject:english+classics&filter=paid-ebooks&key=${apiKey}`,
  );
