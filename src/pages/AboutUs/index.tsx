import { BookCopy, Glasses, Heart } from "lucide-react";

const AboutUs = () => {
  return (
    <section className="bg-gray-50 px-14 py-10">
      <div className="mx-auto h-36 rounded-md bg-[url('/assets/about-us/bg-1.jpg')] bg-cover bg-center lg:h-72 lg:w-full"></div>
      <div className="space-y-20 lg:space-y-40">
        <div className="space-y-4 text-left lg:pt-4">
          <h1 className="text-xl text-yellow-500">About Us</h1>
          <h1 className="font-italiana text-5xl text-emerald-800">
            Life’s Too Short for Bad Books <br></br>
            <span className="text-yellow-500">Let Us Fix that !</span>
          </h1>
        </div>
        <div className="mx-auto flex flex-col space-y-40 lg:px-20">
          <div className="flex">
            <h1 className="text-left text-xl text-emerald-800">
              Welcome to <span className="text-yellow-500">Bookery</span>, Step
              into a world of endless stories and feel-good vibes! Whether
              you’re here to find your next favorite book or just to wander
              among the pages, we’re here to make it unforgettable. Grab a book,
              feel at home, and let the magic begin!
            </h1>
          </div>
          <div className="flex w-full flex-col gap-5 text-emerald-800 lg:flex-row lg:gap-0">
            <div className="font-italiana text-4xl lg:w-1/2">Our Story</div>
            <div className="text-emerald-800 lg:w-1/2">
              In 2025, a small idea grew into a big dream—a bookstore built for
              readers, by readers. What started as a tiny corner with a love for
              great stories has become a haven for book lovers everywhere. We
              believe every book deserves a reader, and every reader deserves a
              story worth telling.
            </div>
          </div>
        </div>
        <div className="mx-auto rounded-md bg-[url('/assets/about-us/bg-2.jpg')] bg-cover bg-center lg:h-72 lg:w-full"></div>
        <div className="flex w-full flex-col justify-between text-emerald-800 lg:flex-row">
          <div className="flex w-full flex-col space-y-4 lg:w-[43%]">
            <h1 className="font-italiana text-5xl text-emerald-800">
              Why Choose Bookery ? <br></br>
            </h1>
            <h1 className="text-md text-neutral-400">
              At Bookery, we’re all about turning book shopping into an
              adventure. Here’s why readers like you love us:
            </h1>
          </div>
          <div className="pt-5 lg:w-[43%] lg:pt-0">
            <div className="space-y-4 lg:w-full lg:space-y-10">
              <div className="space-y-4">
                <Heart
                  size={44}
                  className="rounded-md bg-neutral-100 p-2 text-yellow-500"
                />
                <div className="font-italiana text-2xl text-emerald-800">
                  No Drama, Just Good Books
                </div>
                <div>
                  No hidden costs, no confusing choices—just fair prices and
                  honest advice for book lovers.
                </div>
              </div>
              <div className="space-y-4">
                <BookCopy
                ...
                />
                <div className="font-italiana text-2xl text-emerald-800">
                  No Bad Books Allowed
                </div>
                <div>
                  Our selection is carefully curated to make sure you never
                  waste time on a dud.
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div>
                  Built by people who love books as much as you do, we know
        ...
        <div className="flex w-full justify-between text-emerald-800">
          <div className="flex flex-col text-center lg:w-[43%] lg:space-y-4 lg:text-left">
            <h1 className="font-italiana text-5xl text-emerald-800">
              I have always imagined that Paradise will be a kind of library.{" "}
              <br></br>
            </h1>
            <h1 className="text-md text-neutral-400">– Jorge Luis Borges</h1>
          </div>
          <div className="lg:w-[43%]">
            <div className="mx-auto rounded-md bg-[url('/assets/about-us/bg-3.jpg')] bg-cover bg-center lg:h-80 lg:w-full"></div>
          </div>
        </div>
